...
async execute(message,args,client) {
    ...
    .setAuthor("Searching...", "https://i.gifer.com/BCGc.gif")
    .setColor("#F0EAD6")
    ...
    let resultsEmbed = new MessageEmbed()
      ...
      .setColor("#F0EAD6")
      .setAuthor("Search results!!", "https://i.gifer.com/BCGc.gif","http://harmonymusic.tk")
      .setFooter("Response with your favorite number","https://i.gifer.com/BCGc.gif")
